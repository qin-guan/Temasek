...
// @ts-ignore
import { DutyShiftRequestBuilderRequestsMetadata, type DutyShiftRequestBuilder } from './dutyShift/index.js';
// @ts-ignore
import { ParseNodeFactoryRegistry, SerializationWriterFactoryRegistry, apiClientProxifier, type BaseRequestBuilder, type KeysToExcludeForNavigationMetadata, type NavigationMetadata, type RequestAdapter } from '@microsoft/kiota-abstractions';
// @ts-ignore
...
export interface ApiClient extends BaseRequestBuilder<ApiClient> {
    /**
     * The DutyShift property
     */
    get dutyShift(): DutyShiftRequestBuilder;
}
/**
...
export const ApiClientNavigationMetadata: Record<Exclude<keyof ApiClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    dutyShift: {
        requestsMetadata: DutyShiftRequestBuilderRequestsMetadata,
    },
};
/* tslint:enable */
/* eslint-enable */
